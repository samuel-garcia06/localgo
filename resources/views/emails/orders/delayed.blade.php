@php
    ...
    $eta = $order->updated_at->copy()->addMinutes($prepTime)->format('H:i');
@endphp
<!doctype html>
<html lang="es">
<head>
    <meta charset="utf-8">
    <title>Tu pedido tardará un poco más</title>
</head>
                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:620px;background:#ffffff;border-radius:18px;overflow:hidden;border:1px solid #dfe7df;">
                    <tr>
                        <td style="padding:28px 24px 18px;">
                            ...
                            <h1 style="margin:0;color:#14211b;font-size:26px;line-height:1.2;">Tu pedido tardará un poco más</h1>
                            <p style="margin:14px 0 0;color:#51625a;font-size:15px;line-height:1.6;">
                                Hemos añadido {{ $additionalMinutes }} minutos al tiempo de preparación para que tu pedido salga correctamente.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0 24px 16px;">
                            <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#fff7ed;border:1px solid #fed7aa;border-radius:14px;">
                                <tr>
                                    <td style="padding:16px 18px;">
                                        <p style="margin:0 0 6px;color:#14211b;font-size:14px;font-weight:700;text-transform:uppercase;letter-spacing:.06em;">Nuevo tiempo estimado</p>
                    ...
                    <tr>
                        <td style="padding:0 24px 28px;">
                            <p style="margin:0;color:#7a4b00;background:#fff7df;border:1px solid #ffe3a3;border-radius:12px;padding:12px 14px;font-size:14px;line-height:1.5;">
                                Sentimos la espera. Te avisaremos cuando tu pedido esté listo.
                            </p>
                        </td>
                    </tr>
                </table>
