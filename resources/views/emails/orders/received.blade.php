@php
    ...
    $heading = $customerName !== ''
        ? "Hemos recibido tu pedido, {$customerName}"
...
<head>
    <meta charset="utf-8">
    <title>Pedido recibido #{{ $order->id }}</title>
</head>
                    ...
                    <tr>
                        <td style="padding:28px 24px 18px;">
                            ...
                            <p style="margin:14px 0 0;color:#51625a;font-size:15px;line-height:1.6;">
                                Tu pedido ha sido recibido correctamente. El restaurante lo revisará en breve y te notificará cuando sea confirmado o rechazado.
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding:0 24px 28px;">
                            <p style="margin:0;color:#7a4b00;background:#fff7df;border:1px solid #ffe3a3;border-radius:12px;padding:12px 14px;font-size:14px;line-height:1.5;">
                                Tu pedido está pendiente de confirmación. Recibirás otro email en cuanto el restaurante lo acepte o rechace.
                            </p>
                        </td>
                    </tr>
                </table>
